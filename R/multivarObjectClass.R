...
#' @slot maity_opts List. Options for Maity et al. (2022) MrLasso initial estimation when \code{weightest = "maity"}. Supports \code{eta} (scale parameter for re-descending loss, default 2.0) and \code{thresh_const} (threshold multiplier, default 1.0).
